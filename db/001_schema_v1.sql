...
('brand_background_color', '#f7f4ed', 'string', 'branding', 'Website background color', 1),
...
('brand_logo_url', '/assets/brand-mark.jpg', 'string', 'branding', 'Brand logo image URL', 1),
('brand_top_bar_image_url', '/assets/Main Banner.png', 'string', 'branding', 'Top bar image URL', 1),
('brand_portal_title', 'Annapoorna', 'string', 'branding', 'Portal top bar title', 1),
('brand_portal_subtitle', 'Homemade Fresh Tiffin Service', 'string', 'branding', 'Portal top bar subtitle', 1),
...
('customer_chat_label', 'Chat with us', 'string', 'chat', 'Floating chat button label', 1),
('customer_chat_welcome_message', 'Hi Annapoorna, I have a question.', 'string', 'chat', 'Default chat welcome message', 1),
